		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatemachineAccess().getServicesAssignment_2_1(), "rule__Statemachine__ServicesAssignment_2_1");
					put(grammarAccess.getStatemachineAccess().getStatesAssignment_3(), "rule__Statemachine__StatesAssignment_3");
					put(grammarAccess.getServiceAccess().getTypeAssignment_0(), "rule__Service__TypeAssignment_0");
					put(grammarAccess.getServiceAccess().getNameAssignment_1(), "rule__Service__NameAssignment_1");
					put(grammarAccess.getEventAccess().getResetEventAssignment_0(), "rule__Event__ResetEventAssignment_0");
					...
					put(grammarAccess.getStateAccess().getActionAssignment_2_1(), "rule__State__ActionAssignment_2_1");
