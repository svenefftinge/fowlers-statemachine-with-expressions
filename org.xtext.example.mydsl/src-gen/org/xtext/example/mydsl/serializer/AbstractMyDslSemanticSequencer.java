...
public class AbstractMyDslSemanticSequencer extends AbstractSemanticSequencer {
	...
	protected void sequence_Service(EObject context, Service semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.SERVICE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.SERVICE__TYPE));
		...
		feeder.accept(grammarAccess.getServiceAccess().getTypeJvmTypeReferenceParserRuleCall_0_0(), semanticObject.getType());
	...
	/**
	 * Constraint:
	 *     (name=ID action=XBlockExpression? transitions+=Transition*)
	 */
	...
	/**
	 * Constraint:
	 *     (events+=Event* services+=Service* states+=State*)
	 */
	...
	protected void sequence_Transition(EObject context, Transition semanticObject) {
		if(errorAcceptor != null) {
			...
			if(transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.TRANSITION__STATE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.TRANSITION__STATE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
