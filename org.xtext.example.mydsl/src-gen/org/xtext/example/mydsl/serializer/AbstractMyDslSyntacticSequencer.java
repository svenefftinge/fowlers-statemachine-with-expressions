...
public class AbstractMyDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Statemachine___ServicesKeyword_2_0_EndKeyword_2_2__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Statemachine___ServicesKeyword_2_0_EndKeyword_2_2__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getStatemachineAccess().getServicesKeyword_2_0()), new TokenAlias(false, false, grammarAccess.getStatemachineAccess().getEndKeyword_2_2()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_Statemachine___ServicesKeyword_2_0_EndKeyword_2_2__q.equals(syntax))
				emit_Statemachine___ServicesKeyword_2_0_EndKeyword_2_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ('services' 'end')?
	 */
	protected void emit_Statemachine___ServicesKeyword_2_0_EndKeyword_2_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
