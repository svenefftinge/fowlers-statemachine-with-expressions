 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.StateImpl#getTransitions <em>Transitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends MinimalEObjectImpl.Container implements State
{
  ...
  public NotificationChain basicSetAction(XExpression newAction, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.STATE__ACTION, oldAction, newAction);
  ...
  public void setAction(XExpression newAction)
  {
    if (newAction != action)
    {
      ...
      if (action != null)
        msgs = ((InternalEObject)action).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.STATE__ACTION, null, msgs);
      if (newAction != null)
        msgs = ((InternalEObject)newAction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.STATE__ACTION, null, msgs);
      msgs = basicSetAction(newAction, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.STATE__ACTION, newAction, newAction));
  }
  ...
  public EList<Transition> getTransitions()
  {
    if (transitions == null)
    {
      transitions = new EObjectContainmentEList<Transition>(Transition.class, this, MyDslPackage.STATE__TRANSITIONS);
    }
    return transitions;
  }
